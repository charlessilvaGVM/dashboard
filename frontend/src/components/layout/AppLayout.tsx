...
import { LayoutDashboard, LogOut, Menu, X, BarChart2, ChevronRight, Users, ShieldCheck, Sun, Moon, Activity, Server, DatabaseBackup } from 'lucide-react';
...
const navItems: NavItem[] = [
  ...
  { label: 'Backup',      path: '/backup',       icon: <DatabaseBackup  className="h-5 w-5" />, adminOnly: true },
];
